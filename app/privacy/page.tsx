...
export const metadata: Metadata = {
  title: 'Privacy Policy | St. Catharines Pressure Washing',
  description: 'Privacy policy for St. Catharines Pressure Washing. Learn how we collect, use, and protect your personal information.',
}
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                ...
                <li>Schedule appointments and provide quotes</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-none text-gray-700">
                ...
                <li><strong>Address:</strong> Niagara Region, Ontario</li>
              </ul>
            </section>
          </div>
        </div>
